        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl sm:text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Pakete</h2>
                    <p className="mt-6 text-base leading-8 text-gray-600">
                        Mit unseren festen Preispaketen behalten Sie den klaren Überblick über die Kosten.
                    </p>
                    <p className="mt-6 text-xl leading-8 text-blue">
                                ...
                                >
                                    {paket.features.map((feature) => (
                                        <li key={feature} className="flex gap-x-3">
                                            <CheckOutlined className="h-6 w-5 flex-none text-indigo-600" aria-hidden="true" />
                                            {feature}
                                        </li>
                                    ))}
                                </ul>
