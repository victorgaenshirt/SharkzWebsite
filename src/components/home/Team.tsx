...
export const Team: React.FC = () => {
    return (
        <div className="bg-gray-100">
            ...
            <div className="mx-auto max-w-4xl lg:max-w-6xl gap-x-8 gap-y-20 px-6 lg:px-8">
                ...
                <ul role="list" className="grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 sm:gap-y-16 mx-auto">
                    {people.map((person) => (
                        <li key={person.firstname}>
                            <div className="flex items-center gap-x-6 mx-auto text-center">
